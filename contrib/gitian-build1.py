...
def setup_repos():
    ...
    if not os.path.isdir('dev'):
        subprocess.check_call(['git', 'clone', 'https://github.com/deviantcoin/Deviant-Core.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/deviantcoin/Deviant-Core', help='Specify the URL of the repository. Default is %(default)s')
