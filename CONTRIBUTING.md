...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the DEV unit tests or QA tests
...
[Translation Process](https://github.com/Simple-Software-Solutions/Deviant-Core/blob/master/doc/translation_process.md)
...
confused with overall DEV Network Protocol consensus changes.
...
Patches that change DEV consensus rules are considerably more involved than
...
Where a patchset proposes to change the DEV consensus, it must have been
