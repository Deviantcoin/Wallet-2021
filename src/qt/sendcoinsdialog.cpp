...
void SendCoinsDialog::send(QList<SendCoinsRecipient> recipients, QString strFee, QStringList formatted)
{
    ...
    proceDEVendCoinsReturn(prepareStatus,
    ...
    proceDEVendCoinsReturn(sendStatus);
...
void SendCoinsDialog::proceDEVendCoinsReturn(const WalletModel::SendCoinsReturn& sendCoinsReturn, const QString& msgArg, bool fPrepare)
{
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel()) {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Deviant-Core address"));
        } else // Valid address
        {
            CPubKey pubkey;
            CKeyID keyid;
