...
bool parseBitcoinURI(QString uri, SendCoinsRecipient* out)
{
    // Convert dev:// to dev:
    //
    //    Cannot handle this later, because dev:// will cause Qt to see the part after // as host,
...
bool openConfigfile()
{
    ...
    /* Open dev.conf with the associated application */
...
{
    return GetAutostartDir() / "dev.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a dev.desktop file to the autostart directory:
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the dev app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add dev app to startup item list
