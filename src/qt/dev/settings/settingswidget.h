...
#include "qt/dev/settings/settingsbackupwallet.h"
#include "qt/dev/settings/settingsexportcsv.h"
#include "qt/dev/settings/settingsbittoolwidget.h"
#include "qt/dev/settings/settingssignmessagewidgets.h"
#include "qt/dev/settings/settingswalletrepairwidget.h"
#include "qt/dev/settings/settingswalletoptionswidget.h"
#include "qt/dev/settings/settingsmainoptionswidget.h"
#include "qt/dev/settings/settingsdisplayoptionswidget.h"
#include "qt/dev/settings/settingsmultisendwidget.h"
