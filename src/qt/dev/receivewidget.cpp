...
#include "qt/dev/forms/ui_receivewidget.h"
#include "qt/dev/furlistrow.h"
#include "qt/dev/myaddressrow.h"
#include "qt/dev/qtutils.h"
#include "qt/dev/requestdialog.h"
...
ReceiveWidget::ReceiveWidget(DEVGUI* parent) : PWidget(parent),
                                               ui(new Ui::ReceiveWidget)
{
    ...
    setCDEVubtitleScreen(ui->labelDate);
    ui->labelLabel->setText("");
    setCDEVubtitleScreen(ui->labelLabel);
