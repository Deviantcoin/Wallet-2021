...
#include "qt/dev/expandablebutton.h"
#include "qt/dev/forms/ui_expandablebutton.h"
...
void ExpandableButton::setButtonClaDEVtyle(const char *name, const QVariant &value, bool forceUpdate)
{
