...
{
    const char* pszTimestamp = "Deviant - powered by CryptoDevs.co.uk and CDEV coin. Provider of quality wallets and related services.";
...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("seed01.deviantnode.app", "seed01.deviantnode.app"));
