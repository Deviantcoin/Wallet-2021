...
"""Verify that starting dev with -h works as expected."""
import subprocess

from test_framework.test_framework import devTestFramework
from test_framework.util import assert_equal

class HelpTest(devTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dev with -h for help text")
        ...
        self.log.info("Start dev with -version for version information")
