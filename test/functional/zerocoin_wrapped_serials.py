#!/usr/bin/env python3
# Copyright (c) 2019 The Deviant Core developers
...
from fake_stake.base_test import deviant_FakeStakeTest

class zdevwrappedSerialsTest(deviant_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zdevs..." % DENOM_TO_USE)
