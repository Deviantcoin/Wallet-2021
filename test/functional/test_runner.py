...
`test/functional/test_framework/test_framework.py:devTestFramework.main`.
...
def main():
    ...
    tmpdir = "%s/dev_test_runner_%s" % (args.tmpdirprefix, datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))
    os.makedirs(tmpdir)
