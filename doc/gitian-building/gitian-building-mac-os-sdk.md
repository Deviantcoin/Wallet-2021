...
The script [extract-osx-sdk.sh](https://github.com/Simple-Software-Solutions/Deviant-Core/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
DEV/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Simple-Software-Solutions/Deviant-Core/blob/master/doc/README_osx.md) for troubleshooting tips.