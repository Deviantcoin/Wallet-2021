...
The build script we'll be using is contained in the DEV github repository ([contrib/gitian-build.py](https://github.com/Simple-Software-Solutions/Deviant-Core/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the DEV repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Deviant-Core/DEV/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, DEV-detached-sigs, and DEV GitHub repos.
