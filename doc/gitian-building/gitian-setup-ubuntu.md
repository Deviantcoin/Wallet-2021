...
The build script we'll be using is contained in the DEV github repository ([contrib/gitian-build.py](https://github.com/deviantcoin/Deviant-Core/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the DEV repository and will need to fetch this script with the following commands:
