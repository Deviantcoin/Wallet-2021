...
Acquire the source in the usual way:
    ...
    git clone https://github.com/SimpleSoftwareSolutions/DEV.git
    cd DEV
...
example /usr/src/DEV, AND not under /mnt/d/. If this is not the case the dependency autoconf scripts will fail.
...
way. This will install to `c:\workspace\DEV`, for example:

    make install DESTDIR=/mnt/c/workspace/DEV
