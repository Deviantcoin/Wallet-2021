...
In order to support loading of multiple wallets in deviant-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is DEVolutions.cpp.
...
Changes to DEVolutions.cpp
----------------------
DEVolutions.cpp is the entry point into deviant-qt, and as such, will require some minor modifications to provide hooks for
